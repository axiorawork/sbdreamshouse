...
const contacts = [
  {
    ...
    Icon: Phone,
    bgColor: "#C89B4A",
    shadowColor: "rgba(200,155,74,0.4)",
    isLucide: true,
  },
  {
    id: "whatsapp",
  ...
  {
    id: "instagram",
    href: "https://instagram.com/sbdreamshouse",
    Icon: InstagramIcon,
    bgColor: "#E1306C",
  ...
  {
    id: "facebook",
    href: "https://facebook.com/sbdreamshouse",
    Icon: FacebookIcon,
    bgColor: "#1877F2",
...
export default function FloatingContact() {
  return (
    <div
      className="fixed bottom-10 right-8 z-50 flex flex-col items-center gap-5"
      role="complementary"
      ...
      {contacts.map((item, i) => (
        <motion.a
          ...
          transition={{
            ...
            ease: "easeInOut",
            repeat: Infinity,
            delay: i * 0.2, // Stagger the breathing effect
          }}
